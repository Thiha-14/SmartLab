        ...
        <div className="xl:col-span-2 bg-white p-10 rounded-[48px] border border-slate-50 shadow-sm">
          ...
          <div className="grid grid-cols-7 gap-6">
            {Array.from({ length: 31 }).map((_, i) => {
              ...
              return (
                <div key={i} className={`aspect-square flex flex-col items-center justify-center rounded-[28px] border-2 transition-all group relative cursor-pointer ${found
            ...
            {holidays.map((holiday) => (
              <div key={holiday.id} className="group p-6 bg-slate-50/50 rounded-[32px] border border-slate-100 hover:border-blue-200 hover:bg-white hover:shadow-2xl hover:shadow-blue-500/5 transition-all">
                <div className="flex justify-between items-start mb-4">
                  <span className={`text-[9px] font-black uppercase px-3 py-1.5 rounded-full tracking-widest ${holiday.type === 'Public' ? 'bg-rose-100 text-rose-600' : 'bg-blue-100 text-blue-600'
                    }`}>
